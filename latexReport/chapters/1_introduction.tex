...
Dado el volumen de cómputo involucrado ---especialmente para imágenes de grandes
dimensiones---, este trabajo explora y compara distintas \textbf{estrategias de
...
\begin{itemize}
  ...
  \item \textbf{Memoria compartida (OpenMP):} paralelismo a nivel de hilos dentro de un
        único nodo mediante directivas de compilador.
  \item \textbf{Memoria distribuida (MPI):} paralelismo mediante paso de mensajes entre
        procesos, potencialmente en distintos nodos.
