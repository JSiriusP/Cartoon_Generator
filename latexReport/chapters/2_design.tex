...
\begin{itemize}
      \item MPI: Se reutilizo el código generado en el algoritmo con memoria distribuida.
      \item OpenMP: Se agregaron a los bucles del anterior código, las directrices que se utilizaron previamente en el algoritmo con memoria compartida.
\end{itemize}
La suma que se realiza al final para juntar los resultados del posterizado y borroneado se decidio que se paralelizara utilizando únicamente OpenMP, como se vio en el anterior algoritmo, los tiempos aumentaban al paralelizarla con MPI pero OpenMP almenos en un entorno local resulta ser mucho más eficiente.
