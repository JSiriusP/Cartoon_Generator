...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../benchmark/graficos/CJ-1-eficiencia.png}
    \caption{Eficiencia paralela promedio en entorno local comparando OpenMP, MPI e Híbrido frente al comportamiento Ideal.}
    \label{fig:eficiencia_cluster}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../benchmark/graficos/RC-2-eficiencia.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../benchmark/graficos/CJ-1-heatmap_speedup.png}
    \caption{Heatmap de Speedup detallado por escenario y configuración en entorno local.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../benchmark/graficos/CJ-1-escalabilidad.png}
    \caption{Escalabilidad: Speedup promedio de la mejor configuración de cada implementación en función del tamaño de la imagen (local).}
