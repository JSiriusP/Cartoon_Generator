...
paralelización} con el fin de reducir el tiempo de procesamiento. Se implementan las versiones del algoritmo:
 
\begin{itemize}
  \item \textbf{Secuencial:} implementación de referencia, sin paralelismo.
  \item \textbf{GPU (CUDA):} paralelismo masivo a nivel de \textit{threads} concurrentes en el hardware acelerador, optimizando los accesos mediante una jerarquía de memoria global y compartida.
\end{itemize}
